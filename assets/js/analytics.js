(() => {
  ...
  function visibleSeconds() {
    return Math.round((visibleMilliseconds + (visibleStartedAt ? Date.now() - visibleStartedAt : 0)) / 1000);
  }
  ...
  addEventListener("pagehide", () => send("page_hidden", { visible_seconds: visibleSeconds(), elapsed_seconds: Math.round((Date.now() - startedAt) / 1000) }));
})();
